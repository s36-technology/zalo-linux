...
Each dumped file is a valid standalone Mach-O binary. The output directory is created automatically if it does not exist. Output files are named `<original_filename>.<arch_name>`.
