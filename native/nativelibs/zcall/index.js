...
var VCMac = shouldUseLinuxCallBackend() ? require('./vclinux.js') : require('./vcmac.js');
...
class ZVCMac{
	...
	answerIncomingCall(){
		if(this.zmac && typeof this.zmac.answerIncomingCall === 'function'){
			this.zmac.answerIncomingCall();
		}
	}
