...
class Log extends AbstractLog {
    ...
    initForApp() {
        if (!writeStream) {
            fs = require('fs');
            writeStream = fs.createWriteStream(findLogPath(), {
                flags: 'a'
            });
        }
...
class LogTransport extends LogTransportBase {
    ...
    send(data) {
        ...
        if (this.platform === 'WEB') {
            ...
            switch (data.level) {
                case 'DEBUG':
                    console.debug('%c' + messageFormat, 'color: #0eae4a;');
                    break;
                case 'WARN ':
                ...
                case 'ERROR':
                    ...
                    break;
                case 'INFO ':
                    console.info('%c' + messageFormat, 'color: #029ee0');
                    break;
                default:
                    console.info('%c' + messageFormat, 'color: #0299ee0');
                    break;
            }
            return;
        }
...
module.exports.setOnLogWeb = (val) => {
    onLogWeb = !!val
}
module.exports.setOffLog = (val) => {
    offLog = !!val
}


module.exports.Core = new Log(Object.assign(options, {
    byName: 'Core'
}));
module.exports.Son = new Log(Object.assign(options, {
    byName: 'Son'
}));
module.exports.Anh = new Log(Object.assign(options, {
    byName: 'Anh'
}));
module.exports.Toan = new Log(Object.assign(options, {
    byName: 'Toan'
}));
module.exports.Dang = new Log(Object.assign(options, {
    byName: 'Dang'
}));
module.exports.Bach = new Log(Object.assign(options, {
    byName: 'Bach'
}));
module.exports.Dung = new Log(Object.assign(options, {
    byName: 'Dung'
}));
module.exports.Huynh = new Log(Object.assign(options, {
    byName: 'Huynh'
}));
module.exports.Tai = new Log(Object.assign(options, {
    byName: 'Tai'
}));
module.exports.Thien = new Log(Object.assign(options, {
    byName: 'Thien'
}));
module.exports.Tri = new Log(Object.assign(options, {
    byName: 'Tri'
}));
module.exports.Kha = new Log(Object.assign(options, {
    byName: 'Kha'
}));
module.exports.Dat = new Log(Object.assign(options, {
    byName: 'Dat'
}));
module.exports.Hai = new Log(Object.assign(options, {
    byName: 'Hai'
}));
module.exports.Vi = new Log(Object.assign(options, {
    byName: 'Vi'
}));