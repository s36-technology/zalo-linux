    ...
    function(t) {
        ...
        "8+WD": function(t, e, n) {
            ...
            Object.defineProperty(self, "onmessage", Object(r.a)(Object(r.a)({}, a), {}, {
                ...
                if (Object(o.f)(e)) {
                    const [t, n] = e;
                    t === Object(o.b)(i.m) && self.importScripts(n)
                }
            }))
        },
        "8LbN": function(t, e, n) {
        ...
        S8fy: function(t, e, n) {
            ...
            var S = function(t) {
                ...
                w = function() {
                    function t(t) {
                        this.parent = t, this._registry = new b, this.interceptors = new T
                    }
        ...
        UmSQ: function(t, e, n) {
            ...
            var r = n("jDHv");
            const i = "worker-sync-configs",
                o = Object(r.define)("config")
        },
        VTBJ: function(t, e, n) {
            "use strict";
        ...
        b8N4: function(t, e, n) {
            ...
            function c(t) {
                return Array.isArray(t) && t[0] && r.p.includes(s(t[0]))
            }
                        ...
                        void 0 === i.Reflect ? i.Reflect = n : o = s(i.Reflect, o),
                            function(e) {
                                ...
                                function _(t, e, n, r) {
                                    ...
                                    if (!Y(r) && !L(r) && !U(r)) throw new TypeError;
                                    return U(r) && (r = void 0), w(t, e, n = z(n), r)
                                }
                                ...
                                function y(t, e, n, r) {
                                    if (!Y(n)) throw new TypeError;
                                    return L(r) || (r = z(r)), D(t, e, n, r)
                                }

                                function m(t, e, n) {
                                    if (!Y(e)) throw new TypeError;
                                    return L(n) || (n = z(n)), N(t, e, n)
                                }

                                function b(t, e, n) {
                                    if (!Y(e)) throw new TypeError;
                                    return L(n) || (n = z(n)), k(t, e, n)
                                }

                                function v(t, e, n) {
                                    if (!Y(e)) throw new TypeError;
                                    return L(n) || (n = z(n)), C(t, e, n)
                                }

                                function E(t, e, n) {
                                    if (!Y(e)) throw new TypeError;
                                    return L(n) || (n = z(n)), x(t, e, n)
                                }

                                function S(t, e) {
                                    if (!Y(t)) throw new TypeError;
                                    return L(e) || (e = z(e)), I(t, e)
                                }

                                function O(t, e) {
                                    if (!Y(t)) throw new TypeError;
                                    return L(e) || (e = z(e)), A(t, e)
                                }
                                ...
                                function C(t, e, n) {
                                    if (k(t, e, n)) return x(t, e, n);
                                    var r = tt(e);
                                    return U(r) ? void 0 : C(t, r, n)
                                }
                                ...
                                e("decorate", _), e("metadata", g), e("defineMetadata", y), e("hasMetadata", m), e("hasOwnMetadata", b), e("getMetadata", v), e("getOwnMetadata", E), e("getMetadataKeys", S), e("getOwnMetadataKeys", O), e("deleteMetadata", T)
                            }(o)
                    }()
                }(n || (n = {}))
        ...
        pevS: function(t, e, n) {
            ...
            t.exports = function(t, e) {
                var n, l, d, p, h, _, g, y, m = t.target,
                    ...
                    O = b ? s : s[m] || (s[m] = {}),
                    T = O.prototype;
                for (d in e) n = !o(b ? d : m + (v ? "." : "#") + d, t.forced) && S && u(S, d), h = O[d], n && (_ = t.noTargetGet ? (y = i(S, d)) && y.value : S[d]), p = n && _ ? _ : e[d], n && typeof h == typeof p || (g = t.bind && n ? c(p, r) : t.wrap && n ? f(p) : E && "function" == typeof p ? c(Function.call, p) : p, (t.sham || p && p.sham || h && h.sham) && a(g, "sham", !0), O[d] = g, E && (u(s, l = m + "Prototype") || a(s, l, {}), s[l][d] = p, t.real && T && !T[d] && a(T, d, p)))
            }
        },
        qUYh: function(t, e, n) {
            "use strict";
        ...
        wudS: function(t, e, n) {
            ...
            function a(t) {
                ...
                if (-1 === e) {
                    const n = s();
                    n.push(t), e = n.length - 1, globalThis.localStorage.setItem(o, JSON.stringify(n))
                }
                return e
            }
        ...
        zkos: function(t, e, n) {
            ...
            var r = n("UmSQ"),
                ...
                c = n("MPV0"),
                a = n("wudS");
            const u = "load-original-script",
                f = "dal-qos",
                l = "dal-sqlite-path-utils",
                d = "database-state-storage",
                p = "dal-port-manager/get-name-of-target-script-request",
                h = "dal-port-manager/get-name-of-target-script-response",
                _ = "zmsg-channel-get-ports-request",
                g = "zmsg-channel-get-ports-response",
                y = "localstorage-key-changed",
                m = "get-is-migrate-full-done/request",
                b = "get-is-migrate-full-done/response",
                v = "get-is-fask-track/request",
                E = "get-is-fask-track/response";
            let S = function(t) {
            ...
            const O = [c.a.PORT_TRANSFERRED_V2],
                T = [i.a.IPC_DB_AUTHENTICATED, i.a.IPC_START_CLOSE_DBS, c.a.CHANNEL_ESTATBLISHED, c.a.CHANNEL_DISCONNECTED, c.a.CHANNEL_TERMINATED, s.a.NEW_SESSION],
                j = [i.a.IPC_FINISH_CLOSE_DBS, i.a.IPC_DB_CLIENT_CONNECTED, c.a.PORT_DELIVERED, c.a.OPEN_CHANNEL_TO, o.a.SCRIPT_CONNECTED],
                w = [...T, ...j, ...O, u, _, g, y, f, l, d, p, h, m, b, v, E, S.NOTIFY_DB_FAIL, S.NOTIFY_BU_READY, S.NOTIFY_OPEN_DB_FAIL, S.ZOS_CHANNEL_OUT_OF_MEM, S.FORCE_CHECK_DB_CORRUPTION, r.b],
                R = [a.a]
        }
    });
//# sourceMappingURL=sourcemaps/dal-worker.e08d0d44f38873747a6b.js.map