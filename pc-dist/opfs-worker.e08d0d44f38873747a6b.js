    ...
    function(t) {
        ...
        S8fy: function(t, e, n) {
            ...
            var S = function(t) {
                ...
                j = function() {
                    function t(t) {
                        this.parent = t, this._registry = new b, this.interceptors = new O
                    }
        ...
        Tv80: function(t, e, n) {
            ...
            let r = function(t) {
                    return t.ping = "ping", t.initBinaryLogFile = "initBinaryLogFile", t.getFileSize = "getFileSize", t.readRange = "readRange", t.writeRange = "writeRange", t.getWebLogFileAsBuffer = "getWebLogFileAsBuffer", t.removeFile = "removeFile", t.closeWorker = "closeWorker", t.lockForSingleInstanceWeb = "lockForSingleInstanceWeb", t.unlockForSingleInstanceWeb = "unlockForSingleInstanceWeb", t
                }({}),
                i = function(t) {
                    return t.pong = "pong", t.onWorkerReady = "onWorkerReady", t.responseInitBinaryFile = "responseInitBinaryFile", t.responseFileSize = "responseFileSize", t.responseReadRange = "responseReadRange", t.responseWriteRange = "responseWriteRange", t.responseGetWebLogFileAsBuffer = "responseGetWebLogFileAsBuffer", t.responseZLogAccessGranted = "responseZLogAccessGranted", t
                }({})
        },
        "UJ/E": function(t, e, n) {
            "use strict";
        ...
        gqaZ: function(t, e, n) {
            ...
            let a = !1;
            const c = async t => {
                if (a) return i.c.Failure({
                    code: o.a.LockedForSingleWebInstance,
                    message: "ZLog Task is disabled on deactivated tabs to grant single access to current active tab"
                });
                if (s.has(t)) return i.c.Success(s.get(t));
                const e = await navigator.storage.getDirectory(),
                    n = await e.getFileHandle(t, {
                        create: !0
                    }),
                    r = await n.createSyncAccessHandle();
                return s.set(t, r), i.c.Success(r)
            }, u = () => {
                s.forEach((t => {
                    t.flush(), t.close()
                })), s.clear()
                ...
                try {
                    switch (e.type) {
                        ...
                        case r.b.initBinaryLogFile: {
                            ...
                            self.postMessage({
                                type: r.a.responseInitBinaryFile,
                                payload: {
                                    filePath: t.filePath,
                                    response: n
                                }
                        ...
                        case r.b.readRange: {
                            const t = e.payload,
                                n = await (async (t, e, n) => {
                                    ...
                                    let a;
                                    try {
                                        if (0 === s.getSize()) a = i.c.Failure({
                                            code: o.a.FileNotFound,
                                        ...
                                        zconsole.error("ZLOG: readRange has error", u), a = i.c.Failure({
                                            code: o.a.UnknownError,
                                            message: `readRange failed for ${t}`
                                        })
                                    }
                        ...
                        case r.b.getWebLogFileAsBuffer: {
                            const t = e.payload,
                                n = await (async t => {
                                    const e = await c(t);
                                    if ("ERROR" === e.type) return e;
                                    ...
                                    try {
                                        ...
                                        zconsole.error("ZLOG: getAllFileContent throws error", s), r = i.c.Failure({
                                            code: o.a.UnknownError,
                                            message: `readRange failed for ${t}`
                                        })
                                    }
                            ...
                            self.postMessage({
                                type: r.a.responseGetWebLogFileAsBuffer,
                                payload: {
                                    filePath: t.filePath,
                                    response: n
                                }
                        ...
                        case r.b.closeWorker:
                            u(), self.close();
                            break;
                        case r.b.lockForSingleInstanceWeb:
                            a = !0, u();
                            break;
                        case r.b.unlockForSingleInstanceWeb:
                            u(), a = !1, self.postMessage({
                                type: r.a.responseZLogAccessGranted
                            })
                    }
                } catch (n) {
                        ...
                        void 0 === i.Reflect ? i.Reflect = n : o = s(i.Reflect, o),
                            function(e) {
                                ...
                                function _(t, e, n, r) {
                                    ...
                                    if (!F(r) && !U(r) && !L(r)) throw new TypeError;
                                    return L(r) && (r = void 0), j(t, e, n = z(n), r)
                                }

                                function g(t, e) {
                                    function n(n, r) {
                                        if (!F(n)) throw new TypeError;
                                        if (!U(r) && !q(r)) throw new TypeError;
                                        D(t, e, n, r)
                                    }
                                    return n
                                }
                                ...
                                function y(t, e, n, r) {
                                    if (!F(n)) throw new TypeError;
                                    return U(r) || (r = z(r)), D(t, e, n, r)
                                }

                                function m(t, e, n) {
                                    if (!F(e)) throw new TypeError;
                                    return U(n) || (n = z(n)), k(t, e, n)
                                }

                                function b(t, e, n) {
                                    if (!F(e)) throw new TypeError;
                                    return U(n) || (n = z(n)), x(t, e, n)
                                }

                                function v(t, e, n) {
                                    if (!F(e)) throw new TypeError;
                                    return U(n) || (n = z(n)), N(t, e, n)
                                }

                                function E(t, e, n) {
                                    if (!F(e)) throw new TypeError;
                                    return U(n) || (n = z(n)), C(t, e, n)
                                }

                                function S(t, e) {
                                    if (!F(t)) throw new TypeError;
                                    return U(e) || (e = z(e)), I(t, e)
                                }

                                function T(t, e) {
                                    if (!F(t)) throw new TypeError;
                                    return U(e) || (e = z(e)), A(t, e)
                                }
                                ...
                                function G(t, e) {
                                    if ("string" === e) {
                                        var n = t.toString;
                                        if (Z(n))
                                            if (!F(i = n.call(t))) return i;
                                        if (Z(r = t.valueOf))
                                            if (!F(i = r.call(t))) return i
                                    } else {
                                        var r;
                                        if (Z(r = t.valueOf))
                                            if (!F(i = r.call(t))) return i;
                                ...
                                e("decorate", _), e("metadata", g), e("defineMetadata", y), e("hasMetadata", m), e("hasOwnMetadata", b), e("getMetadata", v), e("getOwnMetadata", E), e("getMetadataKeys", S), e("getOwnMetadataKeys", T), e("deleteMetadata", O)
                            }(o)
                    }()
                }(n || (n = {}))
        ...
        pevS: function(t, e, n) {
            ...
            t.exports = function(t, e) {
                var n, l, d, p, h, _, g, y, m = t.target,
                    b = t.global,
                    v = t.stat,
                    E = t.proto,
                    S = b ? r : v ? r[m] : (r[m] || {}).prototype,
                    T = b ? s : s[m] || (s[m] = {}),
                    O = T.prototype;
                for (d in e) n = !o(b ? d : m + (v ? "." : "#") + d, t.forced) && S && u(S, d), h = T[d], n && (_ = t.noTargetGet ? (y = i(S, d)) && y.value : S[d]), p = n && _ ? _ : e[d], n && typeof h == typeof p || (g = t.bind && n ? a(p, r) : t.wrap && n ? f(p) : E && "function" == typeof p ? a(Function.call, p) : p, (t.sham || p && p.sham || h && h.sham) && c(g, "sham", !0), T[d] = g, E && (u(s, l = m + "Prototype") || c(s, l, {}), s[l][d] = p, t.real && O && !O[d] && c(O, d, p)))
            }
        },
        qUYh: function(t, e, n) {
            "use strict";
...
//# sourceMappingURL=sourcemaps/opfs-worker.e08d0d44f38873747a6b.js.map